...
func request_Repository_New_0(ctx context.Context, marshaler runtime.Marshaler, client RepositoryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterRepositoryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RepositoryClient) error {
	...
	mux.Handle("POST", pattern_Repository_New_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Repository_New_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Repository_New_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Repository_New_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "link"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Repository_New_0 = runtime.ForwardResponseMessage
)
